...
import net.sunrise.config.AspectConfig;
import net.sunrise.config.BaseConfiguration;
import net.sunrise.config.H2Config;
import net.sunrise.config.JpaAuditingConfig;
import net.sunrise.config.PostgresConfig;
import net.sunrise.config.WebSecurityConfiguration;
import net.sunrise.dispatch.GlobalDataRepositoryManager;
import net.sunrise.manager.mail.ThymeleafMailConfig;
import net.sunrise.manager.mail.freemarker.FreeMarkerEmailConfiguration;
