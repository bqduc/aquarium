...
import net.sunrise.manager.catalog.ProjectServiceManager;
...
public class ProjectController extends BaseController { 
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7597043611578102767L;
    ...
    public String createForm(Model model) {
		model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, new Project());
	...
	*/
	...
	public String create(@ModelAttribute Project project, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, project);
			return PAGE_CONTEXT + "projectCreate";
		}
    ...
    public String updateForm(@PathVariable("id") Long id, Model model) {
			model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, businessServiceManager.get(id));
			return PAGE_CONTEXT + "projectCreate";
    }
