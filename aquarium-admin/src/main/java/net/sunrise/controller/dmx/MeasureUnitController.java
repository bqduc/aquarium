...
public class MeasureUnitController extends BaseController { 
   ...
   */
	...
	public String createForm(Model model) {
		model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, new MeasureUnit());
	...
	*/
	...
	public String create(@Valid MeasureUnit measureUnit, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, measureUnit);
			return PAGE_CONTEXT + "measureUnitEdit";
		}
  ...
  public String updateForm(@PathVariable("id") Long id, Model model) {
		model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, businessService.get(id));
		return PAGE_CONTEXT + "measureUnitEdit";
  }
