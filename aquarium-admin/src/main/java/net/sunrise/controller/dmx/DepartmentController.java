...
public class DepartmentController extends BaseController { 
   ...
   */
    ...
    public String createForm(Model model) {
		model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, new Department());
	...
	*/
	...
	public String create(@Valid Department department, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, department);
			return PAGE_CONTEXT + "departmentEdit";
		}
