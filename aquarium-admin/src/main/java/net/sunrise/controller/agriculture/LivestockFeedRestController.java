package net.sunrise.controller.agriculture;
...
import net.sunrise.manager.agricultural.LivestockFeedManager;

@RestController
@RequestMapping(value = CommonConstants.REST_API + ControllerConstants.REQUEST_MAPPING_LIVESTOCK_FEED)
@Api(tags = {"livestockFeeds"})
public class LivestockFeedRestController extends BaseRestController<LivestockFeed> {
