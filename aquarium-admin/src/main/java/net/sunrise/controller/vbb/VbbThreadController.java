package net.sunrise.controller.vbb;
...
import net.sunrise.manager.contact.ContactProfileManager;
import net.sunrise.manager.vbb.VbbPostManager;
import net.sunrise.manager.vbb.VbbThreadManager;
import net.sunrise.manager.vbb.VbbTopicManager;
import net.sunrise.utility.ImageUtil;
...
public class VbbThreadController extends BaseController {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6140562379193232355L;
