...
public class ScheduleController extends BaseController { 
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5025684830948263817L;
   ...
   */
	...
	public String createForm(Model model) {
		...
		.builder()
		.build();
		model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, newBusinessPackage);
