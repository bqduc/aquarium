package net.sunrise.controller.dxp;
...
public class ItemController extends BaseController { 
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1318941189959908635L;
   ...
   */
	...
	*/
    ...
    public String updateForm(@PathVariable("id") Long id, Model model) {
			model.addAttribute(net.sunrise.common.CommonConstants.FETCHED_OBJECT, enterpriseManager.getObject(id));
			return PAGE_CONTEXT_PREFIX + ControllerConstants.EDIT;
    }
