...
import net.brilliance.common.utility.CompressionUtility;
...
public class PersistenceResourceController extends BaseController {
	...
	public ResponseEntity<Resource> downloadFile(@PathVariable String fileId) {
		...
		PersistenceResource fetchedBizObject = persistenceResourceService.getObject(Long.valueOf(fileId));
