...
public class DropboxBrowse {
  private DropboxCommon common;

  public DropboxBrowse(DropboxCommon common)
  {
      this.common = common;
  }

  private DbxClientV2 requireDbxClient(HttpServletRequest request, HttpServletResponse response, DropboxUser user)
  ...
  private void renderFolder(HttpServletResponse response, DropboxUser user, DbxClientV2 dbxClient, String path)
      throws IOException
  {
      ...
      out.println("<html>");
      out.println("<head><title>" + StringEscapeUtils.escapeHtml4(path) + "- Web File Browser</title></head>");
      out.println("<body>");
      fp.insertAntiRedressHtml(out);

      out.println("<h2>Path: " + StringEscapeUtils.escapeHtml4(path) + "</h2>");
      ...
      out.println("<input name='targetFolder' type='hidden' value='" + StringEscapeUtils.escapeHtml4(path) + "'/>");
      out.println("</form>");
      ...
      for (Metadata child : children.values()) {
          ...
          out.println("  <li><a href='" + StringEscapeUtils.escapeHtml4(href) + "'>" + StringEscapeUtils.escapeHtml4(child.getName()) + "</a></li>");
      }
      out.println("</ul>");
      ...
      throws IOException
  {
      ...
      out.println("<pre>");
      out.print(StringEscapeUtils.escapeHtml4(f.toStringMultiline()));
      out.println("</pre>");
          ...
          throws IOException, ServletException
  {
      ...
      DropboxUser user = common.getLoggedInUser(request);
      if (user == null) {
          ...
          throws IOException, ServletException
  {
      ...
      DropboxUser user = common.requireLoggedInUser(request, response);
      if (user == null) return;
      ...
      out.println("<html>");
      out.println("<head><title>File uploaded: " + StringEscapeUtils.escapeHtml4(metadata.getPathLower()) + "</title></head>");
      out.println("<body>");
      out.println("<h2>File uploaded: " + StringEscapeUtils.escapeHtml4(metadata.getPathLower()) + "</h2>");
      out.println("<pre>");
      out.print(StringEscapeUtils.escapeHtml4(metadata.toStringMultiline()));
      out.println("</pre>");
      out.println("</body>");
      out.println("</html>");
