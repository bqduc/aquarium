package net.sunrise.service.impl.inventory;
...
import net.sunrise.repository.contact.ProductRepository;
import net.sunrise.repository.specification.inventory.ProductSpecification;
