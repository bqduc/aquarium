 ...
 * @author ducbui
 * 
 * 1. Build configuration for data loading: Column for code, first name, last name, full name, 
 * 2. Q
 *
 */
@Component
public class ContactDataDeploymentHelper {
	private final static String DATA_LOADING_GROUP = "DATA_LOADING";
	private final static String DATA_LOADING_CONTACT = "contactLoadingConfig";

	@Inject
	private ConfigurationService configurationService;

	public Configuration initConfigurations() throws DataLoadingException {
		Optional<Configuration> optConfig = configurationService.getOne(DATA_LOADING_CONTACT);
